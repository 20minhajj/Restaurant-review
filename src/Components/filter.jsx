    ...
    <div id="filters">
      <form>
        <div id="minimum-filter">
          ...
          >
            {props.maxRating >= 1 && <option value="1">&#9733;</option>}
            {props.maxRating >= 2 && <option value="2">&#9733; &#9733;</option>}
            {props.maxRating >= 3 && (
        ...
        <div id="maximum-filter">
          ...
          <select
            ...
            onChange={props.onChange}
          >
            {props.minRating <= 1 && <option value="1">&#9733;</option>}
            {props.minRating <= 2 && <option value="2">&#9733; &#9733;</option>}
            {props.minRating <= 3 && (
              <option value="3">&#9733; &#9733; &#9733;</option>
            )}
            {props.minRating <= 4 && (
